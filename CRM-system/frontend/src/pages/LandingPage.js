            ...
            <div className="flex-1 max-w-2xl z-10">
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                  className="bg-gradient-to-br from-orange-600 to-orange-700 p-2 rounded-lg mr-3"
                >
                  <img src={logo} alt="Logo" className="w-6 h-6 object-contain" />
                </motion.div>
                <div>
                  <h1 className="text-base font-bold text-white leading-tight">xtreative CRM</h1>
                  <p className="text-xs text-orange-400/80 font-normal">Sales Excellence</p>
                </div>
              </motion.div>
              ...
              >
                <motion.button
                  ...
                  className="group px-10 py-4 bg-white text-orange-700 rounded-xl text-base font-bold flex items-center gap-3 shadow-lg hover:shadow-xl transition-all duration-300"
                >
