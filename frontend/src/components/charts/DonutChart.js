...
// Unified color palette - Orange-based theme with harmonious complementary colors
...
const DEFAULT_COLORS = [
  ...
  '#f97316', // Orange - for primary/cash
  '#8b5cf6', // Purple - for special/vip
];

// Orange gradient palette for multi-agent charts (harmonious shades)
...
export const PaymentMethodChart = ({ data, formatCurrency, ...props }) => (
  <DonutChart
    ...
    colors={['#f97316', '#3b82f6']} // Orange (Cash), Blue (Credit)
...
export const StageValueChart = ({ data, formatCurrency, ...props }) => (
  <DonutChart
    ...
    colors={['#3b82f6', '#f59e0b', '#f97316', '#10b981', '#22c55e', '#ef4444']}
    tooltipFormatter={formatCurrency}
    {...props}
  />
);
