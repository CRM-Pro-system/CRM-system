    ...
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      {!isAgent && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <KPICard icon={DollarSign}  title="Sales This Month" value={formatUGX(kpi.monthlyRevenue)} color="orange" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <KPICard icon={AlertCircle} title="Pending Deals"       value={kpi.pendingDeals || 0}   color="orange" />
      ...
      {isAgent && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <KPICard icon={DollarSign}  title="Sales Value"      value={formatUGX(kpi.salesValue)}          color="orange" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <KPICard icon={DollarSign}  title="Monthly Revenue"   value={formatUGX(kpi.salesValue)}          color="orange" />
